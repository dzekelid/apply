...
created: "2018-08-25"
modified: "2018-08-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/apply/master/_listings/aws-elastic-beanstalk/apis.md
...
- name: AWS Elastic Beanstalk API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/apply/master/_listings/aws-elastic-beanstalk/actionapplyenvironmentmanagedaction-get-openapi.md
- name: AWS Elastic Beanstalk API
  x-api-slug: aws-elastic-beanstalk-api
  description: AWS Elastic Beanstalk is an easy-to-use service for deploying and scaling
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/apply/master/_listings/aws-elastic-beanstalk/openapi.md
x-common:
- type: x-api-gallery
